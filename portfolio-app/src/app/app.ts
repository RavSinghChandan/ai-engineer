...
export class App implements OnInit, AfterViewInit {
  ...
  private _match(q: string): string {
    ...
    if (/\b(demo|live\s*demo|see\s*(it|the|a)\s*(demo|app|live|project)|watch|preview|screenshot|show\s*(me\s*)?(the\s*)?(app|demo|live|project|screen))\b/i.test(t))
      return `<div style="margin:0.9rem 0 0.5rem;padding:0.22rem 0.7rem;border-left:3px solid #7c3aed;background:#1e1b4b;border-radius:0 5px 5px 0;font-size:0.7rem;font-weight:800;letter-spacing:0.07em;text-transform:uppercase;color:#a78bfa">▶️ Live Demos — 4 Projects</div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">🔮</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem"><a href="#project-01" style="color:#a78bfa;font-weight:700;text-decoration:none;font-weight:700">Aura with Rav ↗</a></span><span style="grid-column:2;color:#94a3b8;font-size:0.74rem;font-style:italic;line-height:1.45;margin-top:0.05rem">Jump to Project 01 → click the <strong style="color:#f8fafc">Live Demo</strong> button</span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">🏢</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem"><a href="#project-02" style="color:#a78bfa;font-weight:700;text-decoration:none;font-weight:700">Bench Resource Optimizer ↗</a></span><span style="grid-column:2;color:#94a3b8;font-size:0.74rem;font-style:italic;line-height:1.45;margin-top:0.05rem">Jump to Project 02 → click the <strong style="color:#f8fafc">Live Demo</strong> button</span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">📈</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem"><a href="#project-03" style="color:#a78bfa;font-weight:700;text-decoration:none;font-weight:700">Agentic Growth OS ↗</a></span><span style="grid-column:2;color:#94a3b8;font-size:0.74rem;font-style:italic;line-height:1.45;margin-top:0.05rem">Jump to Project 03 → click the <strong style="color:#f8fafc">Live Demo</strong> button</span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">📖</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem"><a href="https://portfolio-quyi2c8kj-ravsinghchandans-projects.vercel.app" target="_blank" style="color:#a78bfa;font-weight:700;text-decoration:none;font-weight:700">RunbookAI — Open Live App ↗</a></span><span style="grid-column:2;color:#94a3b8;font-size:0.74rem;font-style:italic;line-height:1.45;margin-top:0.05rem">Live deployed app — opens directly in new tab! 🚀</span></div><div style="border-top:1px solid rgba(255,255,255,0.12);margin:0.7rem 0"></div><div style="color:#94a3b8;font-size:0.73rem;font-style:italic;margin-top:0.3rem">Projects 01–03: each shows step-by-step screenshots with Aarav guiding you. 🎬</div>`;
    ...
    if (/\b(contact|email|phone|mobile|reach|connect|get in touch|message him|call him|write to)\b/i.test(t))
      return `<div style="margin:0 0 0.5rem;padding:0.22rem 0.7rem;border-left:3px solid #7c3aed;background:#1e1b4b;border-radius:0 5px 5px 0;font-size:0.7rem;font-weight:800;letter-spacing:0.07em;text-transform:uppercase;color:#a78bfa">📬 Reach Chandan</div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">📧</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem"><a href="mailto:ravchandan15@gmail.com" style="color:#a78bfa;font-weight:700;text-decoration:none">ravchandan15@gmail.com</a></span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">📞</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem"><a href="tel:+916290909518" style="color:#a78bfa;font-weight:700;text-decoration:none">+91 62909 09518</a></span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">💼</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem"><a href="https://www.linkedin.com/in/rav-chandan-kumar-singh-767374315/" target="_blank" style="color:#a78bfa;font-weight:700;text-decoration:none">LinkedIn — Rav Chandan Kumar Singh ↗</a></span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">🐙</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem"><a href="https://github.com/RavSinghChandan" target="_blank" style="color:#a78bfa;font-weight:700;text-decoration:none">GitHub — RavSinghChandan ↗</a></span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">▶️</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem"><a href="https://www.youtube.com/@aiwithrav" target="_blank" style="color:#a78bfa;font-weight:700;text-decoration:none">YouTube — @aiwithrav ↗</a></span></div><div style="border-top:1px solid rgba(255,255,255,0.12);margin:0.7rem 0"></div><div style="color:#94a3b8;font-size:0.73rem;font-style:italic">Responds fast — usually within hours! ⚡</div><a href="#contact" style="display:inline-block;font-size:0.74rem;font-weight:700;padding:0.24rem 0.7rem;border-radius:6px;background:#312e81;color:#c7d2fe;border:1px solid #0891b2;margin:0.2rem 0 0;text-decoration:none">↗ Go to Contact Section</a>`;
    ...
    if (/\b(hire|available|open to work|recruit|interview|position|opportunit|notice period|join|remote|relocat|freelanc)\b/i.test(t))
      return `<div style="margin:0.9rem 0 0.5rem;padding:0.22rem 0.7rem;border-left:3px solid #7c3aed;background:#1e1b4b;border-radius:0 5px 5px 0;font-size:0.7rem;font-weight:800;letter-spacing:0.07em;text-transform:uppercase;color:#a78bfa">✅ Open to Senior AI Engineer Roles</div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">🌍</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem">Availability</span><span style="grid-column:2;color:#94a3b8;font-size:0.74rem;font-style:italic;line-height:1.45;margin-top:0.05rem">Remote and on-site · responds within hours</span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">📧</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem"><a href="mailto:ravchandan15@gmail.com" style="color:#86efac">ravchandan15@gmail.com</a></span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">💼</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem"><a href="https://www.linkedin.com/in/rav-chandan-kumar-singh-767374315/" target="_blank" style="color:#86efac">LinkedIn ↗</a></span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">📞</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem">+91 62909 09518</span></div><div style="border-top:1px solid rgba(255,255,255,0.12);margin:0.7rem 0"></div><a href="AI_Engineer_Chandan_Kumar_4_Yrs.pdf" target="_blank" style="display:inline-block;font-size:0.74rem;font-weight:700;padding:0.24rem 0.7rem;border-radius:6px;background:#312e81;color:#c7d2fe;border:1px solid #7c3aed;margin:0.2rem 0.2rem 0 0;text-decoration:none">📄 Download Resume</a><a href="#contact"  style="display:inline-block;font-size:0.74rem;font-weight:700;padding:0.24rem 0.7rem;border-radius:6px;background:#312e81;color:#c7d2fe;border:1px solid #0891b2;margin:0.2rem 0.2rem 0 0;text-decoration:none">↗ Contact Section</a>`;
...
<span class="fn">Mechanical engineer → CS bootcamp → 4 companies → Senior AI Engineer. <em>Self-made. ✨</em></span>`;
    ...
    if (/\b(experience\b|career\b|companies\b|jobs?\b|work(ed)?\s*(at|on|for)\b|timeline\b|accelya\b|nexsys\b|texala\b|flyboard\b|infosys\b|bank(ing)?\b|aviation\b|years?\s*of\b|role\s*at\b)\b/i.test(t))
      return `<div style="margin:0.9rem 0 0.5rem;padding:0.22rem 0.7rem;border-left:3px solid #7c3aed;background:#1e1b4b;border-radius:0 5px 5px 0;font-size:0.7rem;font-weight:800;letter-spacing:0.07em;text-transform:uppercase;color:#a78bfa">💼 Career Timeline — 4+ Years</div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">🟣</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem">Infosys / Bank of America &nbsp;<span style="font-size:0.62rem;padding:0.05rem 0.4rem;border-radius:999px;background:#312e81;color:#c7d2fe">Current</span></span><span style="grid-column:2;color:#94a3b8;font-size:0.74rem;font-style:italic;line-height:1.45;margin-top:0.05rem"><em>Senior SWE · Nov 2025–Present · Pune</em><br>LLM banking automation · Kafka pipelines · <strong style="color:#f8fafc">40% efficiency gain</strong></span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">🔵</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem">Nexsys / Accelya</span><span style="grid-column:2;color:#94a3b8;font-size:0.74rem;font-style:italic;line-height:1.45;margin-top:0.05rem"><em>SWE · Dec 2023–Nov 2025 · Mumbai</em><br>Aviation · 500K+ daily transactions · AI-ready architecture</span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">🟢</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem">Texala</span><span style="grid-column:2;color:#94a3b8;font-size:0.74rem;font-style:italic;line-height:1.45;margin-top:0.05rem"><em>SWE · Jul–Nov 2023 · Pune</em><br>Java / Spring Boot microservices</span></div><div style="display:grid;grid-template-columns:1.5rem 1fr;gap:0.2rem 0.5rem;padding:0.3rem 0;border-bottom:1px solid rgba(255,255,255,0.05)"><span style="font-size:0.95rem;line-height:1.5">🟡</span><span style="font-weight:700;color:#f1f5f9;font-size:0.82rem">Flyboard Ventures</span><span style="grid-column:2;color:#94a3b8;font-size:0.74rem;font-style:italic;line-height:1.45;margin-top:0.05rem"><em>SWE · Aug 2022–Jul 2023 · Chandigarh</em><br>Mobile app · healthcare · e-learning with AI/ML</span></div><div style="border-top:1px solid rgba(255,255,255,0.12);margin:0.7rem 0"></div><a href="#experience"  style="display:inline-block;font-size:0.74rem;font-weight:700;padding:0.24rem 0.7rem;border-radius:6px;background:#312e81;color:#c7d2fe;border:1px solid #d97706;margin:0.2rem 0.2rem 0 0;text-decoration:none">↗ See Full Timeline</a>`;
